import {
    createManyTestContact, createManyTestContacts,
    createTestContact,
    createTestUser,
    getTestContact,
    ...
    it('should reject if request is not valid', async () => {
        const result = await supertest(web)
            ...
            .send({
                ...
                last_name: "test",
                email: "test@localhost.com",
                phone: "111111111111111111111111111111111111111111111111",
            });
...
describe('PUT /api/contacts/:contactId', function () {
    ...
    it('should can update existing contact', async () => {
        ...
        expect(result.status).toBe(200);
        expect(result.body.data.first_name).toBe("samuel");
        expect(result.body.data.last_name).toBe("andrey");
